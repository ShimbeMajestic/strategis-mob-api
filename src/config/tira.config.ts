...
export const tiraConfig = {
    ...
    endpoints: {
        ...
        motorCoverNoteUrl: '/ecovernote/api/covernote/non-life/motor/v1/request',

        nonMotorCoverNoteUrl: '/ecovernote/api/covernote/non-life/other/v1/request',
        ...
        claimDischargeUrl: '/eclaim/api/claim/claim-dischargevoucher/v1/request',
    ...
    signer: {
        ...
        tiraClientPrivateKeyPassword: process.env.TIRA_CLIENT_PRIVATE_KEY_PASSWORD,
